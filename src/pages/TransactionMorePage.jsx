...
const TransactionMorePage = ({totalAmounts}) => {
  let {transactionId}=useParams()

  let amount=totalAmounts.find((totalAmount)=>totalAmount.id === transactionId);
  ...
  return (
    ...
    <Card style={{ width: '40rem',padding:"20px" }}>
      ...
      <Card.Body>
        <Link to="/transaction" style={{textDecoration:"none", width:"100%",background:"blue",display:"block",color:"white",paddingTop:"10px",paddingBottom:"10px",textAlign:"center",borderRadius:"40px"}}>Back to home</Link>
      </Card.Body>
    </Card>
  </div>
  )
...
export default TransactionMorePage